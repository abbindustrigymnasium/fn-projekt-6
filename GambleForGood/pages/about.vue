<template>
    <div class="w-full">
    <div class="flex bg-gray-800" style="height:600px;">
        ...
        <div class="hidden lg:block lg:w-1/2" style="clip-path:polygon(10% 0, 100% 0%, 100% 100%, 0 100%)">
            <div class="h-full object-cover" style="background-image: url(https://i0.wp.com/d1v9pyzt136u2g.cloudfront.net/blog/wp-content/uploads/2022/01/12132647/dice-chips-and-playing-cards.jpg?fit=1100%2C734&ssl=1)">
