...
<section class="pt-20 lg:pt-[80px] pb-12 lg:pb-[90px]">
 ...
 <div class="w-full md:w-1/2 lg:w-1/3 px-4">
    <div
      ...
      <!-- <div class="flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-md text-yellow-100 bg-yellow-700 border border-yellow-700 ">
            <div slot="avatar">
            ...
            <div class="text-xl font-normal  max-w-full flex-initial">
               you are required to select at least one organization</div>
      ...
      <div class="mt-6">
                                  <button
                                      @click="choose" class="flex w-1/3 justify-center px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-indigo-500 rounded-md hover:bg-indigo-400 focus:outline-none focus:bg-indigo-400 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
                                      Continue
                                  </button>
                              </div>
   </div>
...
function choose(){
   if (Checked) navigateTo('/')
   else alert("you are required to select at least one organization")
}
